defmodule Jehuty.Admin do
  ...
  alias Jehuty.Admin.{AdminUser, AdminUserToken, AdminUserNotifier}
  ...
  def change_admin_user_email(admin_user, attrs \\ %{}) do
    AdminUser.email_changeset(admin_user, attrs, validate_email: false)
  end
  ...
  ## Examples
      ...
      iex> deliver_admin_user_update_email_instructions(admin_user, current_email, &url(~p"/admin_user/settings/confirm_email/#{&1})")
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_admin_user_confirmation_instructions(admin_user, &url(~p"/admin_user/confirm/#{&1}"))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_admin_user_confirmation_instructions(confirmed_admin_user, &url(~p"/admin_user/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_admin_user_reset_password_instructions(admin_user, &url(~p"/admin_user/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
