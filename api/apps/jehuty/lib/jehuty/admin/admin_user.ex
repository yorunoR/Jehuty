defmodule Jehuty.Admin.AdminUser do
  ...
  @doc """
  A admin_user changeset for registration.
  ...
  ## Options
    ...
    * `:validate_email` - Validates the uniqueness of the email, in case
      ...
      Defaults to `true`.
  """
  def registration_changeset(admin_user, attrs, opts \\ []) do
    admin_user
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Jehuty.Repo)
  ...
  """
  def valid_password?(%Jehuty.Admin.AdminUser{hashed_password: hashed_password}, password)
